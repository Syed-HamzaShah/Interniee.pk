...
class FeedbackProvider with ChangeNotifier {
  ...
  Future<void> _loadUserFeedbacks() async {
    try {
      ...
      print('Error loading user feedbacks: $e');
      _feedbacks = [];
    }
  ...
  Future<void> _loadAllFeedbacks() async {
    try {
      ...
      _feedbacks = _allFeedbacks;
    } catch (e) {
      print('Error loading all feedbacks: $e');
      _allFeedbacks = [];
      _feedbacks = [];
    }
  ...
  Stream<List<FeedbackModel>> getFeedbacksStream() {
    ...
    try {
        ...
        return _firestore
            ...
            .map((snapshot) {
              try {
                ...
                print('Error parsing feedback documents: $e');
                return <FeedbackModel>[];
              }
            })
            .handleError((error) {
              print('Error in feedback stream: $error');
              return <FeedbackModel>[];
            });
      } else {
        return _firestore
      ...
      print('Error creating feedback stream: $e');
      return Stream.value([]);
    }
  }
