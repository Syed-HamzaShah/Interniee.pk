  ...
  void initState() {
    ...
    _glowAnimation =
        ColorTween(
          ...
          end: AppTheme.primaryGreen.withValues(alpha: 0.1),
        ).animate(
          CurvedAnimation(
                ...
                child: Container(
                  ...
                  child: Padding(
                    padding: ResponsiveHelper.getResponsivePadding(
                      context,
                      mobile: const EdgeInsets.all(AppTheme.spacingLarge),
                      tablet: const EdgeInsets.all(AppTheme.spacingLarge),
                      desktop: const EdgeInsets.all(AppTheme.spacingXLarge),
                    ),
                    child: Column(
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: LinearGradient(
          colors: [_getStatusColor(), _getStatusColor().withValues(alpha: 0.8)],
          ...
          GestureDetector(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                border: Border.all(
                  color: AppTheme.statusCompleted.withValues(alpha: 0.3),
                ),
              ),
              child: Icon(
                Icons.check,
        ...
        if (widget.onEdit != null) ...[
          GestureDetector(
            ...
            child: Container(
              padding: const EdgeInsets.all(AppTheme.spacingSmall),
              decoration: BoxDecoration(
                color: AppTheme.statusInProgress.withValues(alpha: 0.1),
                borderRadius: BorderRadius.circular(AppTheme.borderRadiusSmall),
                border: Border.all(
                  color: AppTheme.statusInProgress.withValues(alpha: 0.3),
                ),
              ),
              child: Icon(
                Icons.edit,
