...
class CreateTaskScreen extends StatefulWidget {
  final String? preSelectedInternId;

  const CreateTaskScreen({super.key, this.preSelectedInternId});
...
class _CreateTaskScreenState extends State<CreateTaskScreen> {
  ...
  void initState() {
    super.initState();
    _selectedInternId = widget.preSelectedInternId;
  }
            ...
            children: [
              ...
              SizedBox(
                ...
                child: ElevatedButton.icon(
                  ...
                  label: Text(
                    taskProvider.isLoading ? 'Creating...' : 'Create Task',
                  ),
  ...
  Future<void> _createTask() async {
    ...
    final success = await taskProvider.createTask(
      ...
      assignedTo: _selectedInternId!,
      assignedBy: authProvider.userModel!.id,
